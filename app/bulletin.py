...
def apply_scales(rows: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    for row in rows:
        ...
        row["month_welcome_color"] = scale_color(int(row.get("month_welcome") or 0), max_month, "month")
        ...
        row["day_welcome_color"] = scale_color(int(row.get("day_welcome") or 0), max_day, "day")
...
def totals_row(rows: Sequence[Mapping[str, Any]]) -> Dict[str, Any]:
    ...
    month_welcome = sum(int(r.get("month_welcome") or 0) for r in rows)
    ...
    day_welcome = sum(int(r.get("day_welcome") or 0) for r in rows)
    ...
    return {
        ...
        "month_welcome_color": scale_color(month_welcome, month_welcome or 1, "month"),
        ...
        "day_welcome_color": scale_color(day_welcome, day_welcome or 1, "day"),
